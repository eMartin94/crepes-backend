...
export const listCart = async (req, res) => {
  ...
  try {
    ...
    console.log(error);
    return res.status(404).json({ message: 'Error al listar el carrito' });
  }
};
...
export const listAllCarts = async (req, res) => {
  try {
    ...
    return res.status(404).json({ message: 'Error al listar carritos' });
  }
};
...
export const addToCart = async (req, res) => {
  ...
  try {
    ...
    console.log(error);
    return res.status(404).json({ message: 'Error al agregar al carrito' });
  }
};
